                                    ...
                                    <div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
                                        ...
                                        <div className="d-flex align-items-center py-1">
                                            ...
                                            <div className="me-4">
                                                ...
                                                {/* <!--begin::Menu 1-->*/}
                                                <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6132282656175">
                                                    {/* <!--begin::Header-->*/}
                                                    ...
                                                    <div className="px-7 py-5">
                                                        ...
                                                        <div className="mb-10">
                                                            ...
                                                            {/* <!--begin::Input-->*/}
                                                            <div>
                                                                <select defaultValue={'1'}className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6132282656175" data-allow-clear="true">
                                                        ...
                                                        <div className="mb-10">
                                                            ...
                                                            <div className="d-flex">
                                                                ...
                                                                <label className="form-check form-check-sm form-check-custom form-check-solid">
                                                                    <input className="form-check-input" type="checkbox" defaultValue="2" defaultChecked />
                                            ...
                                            <div className="col-xxl-4">
                                                ...
                                                <div className="card card-xxl-stretch">
                                                    ...
                                                    <div className="card-header border-0 bg-danger py-5">
                                                        ...
                                                        <div className="card-toolbar">
                                                            ...
                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                                                ...
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#nada" className="menu-link px-3">Create Invoice</a>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#nada" className="menu-link flex-stack px-3">Create Payment
                                                                ...
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#nada" className="menu-link px-3">Generate Bill</a>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
                                                                    <a href="#nada" className="menu-link px-3">
                                                                    ...
                                                                    <div className="menu-sub menu-sub-dropdown w-175px py-4">
                                                                        {/* <!--begin::Menu item-->*/}
                                                                        <div className="menu-item px-3">
                                                                            <a href="#nada" className="menu-link px-3">Plans</a>
                                                                        </div>
                                                                        {/* <!--end::Menu item-->*/}
                                                                        {/* <!--begin::Menu item-->*/}
                                                                        <div className="menu-item px-3">
                                                                            <a href="#nada" className="menu-link px-3">Billing</a>
                                                                        </div>
                                                                        {/* <!--end::Menu item-->*/}
                                                                        {/* <!--begin::Menu item-->*/}
                                                                        <div className="menu-item px-3">
                                                                            <a href="#nada" className="menu-link px-3">Statements</a>
                                                                        </div>
                                                                        {/* <!--end::Menu item-->*/}
                                                                        {/* <!--begin::Menu separator-->*/}
                                                                ...
                                                                <div className="menu-item px-3 my-1">
                                                                    <a href="#nada" className="menu-link px-3">Settings</a>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                            </div>
                                                            {/* <!--end::Menu 3-->*/}
                                                    ...
                                                    <div className="card-body p-0">
                                                        {/* <!--begin::Chart-->*/}
                                                        <div className="mixed-widget-2-chart card-rounded-bottom bg-danger height-200" data-kt-color="danger"></div>
                                                        {/* <!--end::Chart-->*/}
                                                        {/* <!--begin::Stats-->*/}
                                                        <div className="card-p mt-n20 position-relative">
                                                            ...
                                                            <div className="row g-0">
                                                                ...
                                                                <div className="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                                    ...
                                                                    {/* <!--end::Svg Icon-->*/}
                                                                    <a href="#nada" className="text-warning fw-bold fs-6">Weekly Sales</a>
                                                                </div>
                                                                {/* <!--end::Col-->*/}
                                                                {/* <!--begin::Col-->*/}
                                                                <div className="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                                                    ...
                                                                    {/* <!--end::Svg Icon-->*/}
                                                                    <a href="#nada" className="text-primary fw-bold fs-6">New Projects</a>
                                                                </div>
                                                                {/* <!--end::Col-->*/}
                                                            </div>
                                                            {/* <!--end::Row-->*/}
                                                            ...
                                                            <div className="row g-0">
                                                                ...
                                                                <div className="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                                                    ...
                                                                    {/* <!--end::Svg Icon-->*/}
                                                                    <a href="#nada" className="text-danger fw-bold fs-6 mt-2">Item Orders</a>
                                                                </div>
                                                                {/* <!--end::Col-->*/}
                                                                {/* <!--begin::Col-->*/}
                                                                <div className="col bg-light-success px-6 py-8 rounded-2">
                                                                    ...
                                                                    {/* <!--end::Svg Icon-->*/}
                                                                    <a href="#nada" className="text-success fw-bold fs-6 mt-2">Bug Reports</a>
                                                                </div>
                                                                {/* <!--end::Col-->*/}
                                                            </div>
                                                            {/* <!--end::Row-->*/}
                                                ...
                                                <div className="card card-xxl-stretch">
                                                    ...
                                                    <div className="card-header align-items-center border-0 mt-4">
                                                        ...
                                                        <div className="card-toolbar">
                                                            ...
                                                            {/* <!--begin::Menu 1-->*/}
                                                            <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6132282658d25">
                                                                {/* <!--begin::Header-->*/}
                                                                <div className="px-7 py-5">
                                                                    <div className="fs-5 text-dark fw-bolder">Filter Options</div>
                                                                </div>
                                                                ...
                                                                <div className="px-7 py-5">
                                                                    ...
                                                                    <div className="mb-10">
                                                                        ...
                                                                        {/* <!--begin::Input-->*/}
                                                                        <div>
                                                                            <select defaultValue={'1'}className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6132282658d25" data-allow-clear="true">
                                                                                <option defaultValue="1">Approved</option>
                                                                                <option defaultValue="2">Pending</option>
                                                                                <option defaultValue="2">In Process</option>
                                                                                <option defaultValue="2">Rejected</option>
                                                        ...
                                                        <div className="timeline-label">
                                                            ...
                                                            <div className="timeline-item">
                                                                ...
                                                                <div className="timeline-content fw-bolder text-gray-800 ps-3">Make deposit
                                                                    <a href="#nada" className="text-primary">USD 700</a>. to ESL</div>
                                                                {/* <!--end::Desc-->*/}
                                                            </div>
                                                            {/* <!--end::Item-->*/}
                                                            {/* <!--begin::Item-->*/}
                                                            ...
                                                            <div className="timeline-item">
                                                                ...
                                                                <div className="timeline-content fw-bold text-gray-800 ps-3">New order placed
                                                                    <a href="#nada" className="text-primary">#XF-2356</a>.</div>
                                                                {/* <!--end::Desc-->*/}
                                                            </div>
                                                            {/* <!--end::Item-->*/}
                                                            {/* <!--begin::Item-->*/}
                                            ...
                                            <div className="col-xxl-4">
                                                    ...
                                                    <div className="card-body d-flex flex-column p-0">
                                                        ...
                                                        <div className="flex-grow-1 card-p pb-0">
                                                            <div className="d-flex flex-stack flex-wrap">
                                                                <div className="me-2">
                                                                    <a href="#nada" className="text-dark text-hover-primary fw-bolder fs-3">Generate Reports</a>
                                                        ...
                                                        {/* <!--end::Stats-->*/}
                                                        {/* <!--begin::Chart-->*/}
                                                        <div className="mixed-widget-7-chart card-rounded-bottom height-150" data-kt-chart-color="primary"></div>
                                                        {/* <!--end::Chart-->*/}
                                                    </div>
                                                    {/* <!--end::Body-->*/}
                                                </div>
                                                ...
                                                <div className="card card-xxl-stretch-50 mb-5 mb-xl-8">
                                                    ...
                                                    <div className="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                                                        ...
                                                        {/* <!--end::Hidden-->*/}
                                                        {/* <!--begin::Chart-->*/}
                                                        <div className="mixed-widget-10-chart height-175" data-kt-color="primary"></div>
                                                        {/* <!--end::Chart-->*/}
                                                    </div>
                                                </div>
                                                {/* <!--end::Mixed Widget 10-->*/}
                                                    ...
                                                    <div className="card-body pt-2">
                                                        ...
                                                        <div className="d-flex align-items-center mb-8">
                                                            ...
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-gray-800 text-hover-primary fw-bolder fs-6">Create FireStone Logo</a>
                                                        ...
                                                        <div className="d-flex align-items-center mb-8">
                                                            ...
                                                            {/* <!--begin::Description-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-gray-800 text-hover-primary fw-bolder fs-6">Stakeholder Meeting</a>
                                                        ...
                                                        <div className="d-flex align-items-center mb-8">
                                                            ...
                                                            {/* <!--begin::Description-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-gray-800 text-hover-primary fw-bolder fs-6">Scoping &amp; Estimations</a>
                                                        ...
                                                        <div className="d-flex align-items-center mb-8">
                                                            ...
                                                            {/* <!--begin::Description-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-gray-800 text-hover-primary fw-bolder fs-6">KPI App Showcase</a>
                                                                <span className="text-muted fw-bold d-block">Due in 2 Days</span>
                                                            </div>
                                                            {/* <!--end::Description-->*/}
                                                            <span className="badge badge-light-primary fs-8 fw-bolder">New</span>
                                                        ...
                                                        <div className="d-flex align-items-center mb-8">
                                                            ...
                                                            {/* <!--begin::Description-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-gray-800 text-hover-primary fw-bolder fs-6">Project Meeting</a>
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            {/* <!--begin::Description-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-gray-800 text-hover-primary fw-bolder fs-6">Customers Update</a>
                                                ...
                                                <div className="card card-xl-stretch mb-5 mb-xl-8">
                                                    ...
                                                    <div className="card-header border-0 pt-5">
                                                        ...
                                                        <div className="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
                                                            <a href="#nada" className="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
                                                                        ...
                                                                        <td>
                                                                            <div className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex justify-content-start flex-column">
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Ana Simmons</a>
                                                                                    <span className="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <a href="#nada" className="text-dark fw-bolder text-hover-primary d-block fs-6">Intertico</a>
                                                                        ...
                                                                        <td className="text-end">
                                                                            <div className="d-flex flex-column w-100 me-2">
                                                                                ...
                                                                                <div className="progress h-6px w-100">
                                                                                    <div className="progress-bar bg-primary w-50 p-3" role="progressbar"></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div className="d-flex justify-content-end flex-shrink-0">
                                                                                <a href="#nada" className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                                                ...
                                                                                <a href="#nada" className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex justify-content-start flex-column">
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Jessie Clarcson</a>
                                                                                    <span className="text-muted fw-bold text-muted d-block fs-7">C#, ASP.NET, MS SQL</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <a href="#nada" className="text-dark fw-bolder text-hover-primary d-block fs-6">Agoda</a>
                                                                        ...
                                                                        <td className="text-end">
                                                                            <div className="d-flex flex-column w-100 me-2">
                                                                                ...
                                                                                <div className="progress h-6px w-100">
                                                                                    <div className="progress-bar bg-danger w-70 p-3" role="progressbar"></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex justify-content-start flex-column">
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Lebron Wayde</a>
                                                                                    <span className="text-muted fw-bold text-muted d-block fs-7">PHP, Laravel, VueJS</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <a href="#nada" className="text-dark fw-bolder text-hover-primary d-block fs-6">RoadGee</a>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex justify-content-start flex-column">
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Natali Goodwin</a>
                                                                                    <span className="text-muted fw-bold text-muted d-block fs-7">Python, PostgreSQL, ReactJS</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <a href="#nada" className="text-dark fw-bolder text-hover-primary d-block fs-6">The Hill</a>
                                                                        ...
                                                                        <td className="text-end">
                                                                            <div className="d-flex flex-column w-100 me-2">
                                                                                ...
                                                                                <div className="progress h-6px w-100">
                                                                                    <div className="progress-bar bg-warning w-50 p-3" role="progressbar"></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div className="d-flex align-items-center">
                                                                                ...
                                                                                <div className="d-flex justify-content-start flex-column">
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Kevin Leonard</a>
                                                                                    <span className="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td className="text-end">
                                                                            <div className="d-flex flex-column w-100 me-2">
                                                                                ...
                                                                                <div className="progress h-6px w-100">
                                                                                    <div className="progress-bar bg-info w-90 p-3" role="progressbar"></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                ...
                                                <div className="card card-xl-stretch mb-xl-8">
                                                    ...
                                                    <div className="card-header border-0">
                                                        ...
                                                        <div className="card-toolbar">
                                                            ...
                                                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
                                                                ...
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#nada" className="menu-link px-3">New Ticket</a>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#nada" className="menu-link px-3">New Customer</a>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                                                    ...
                                                                    <div className="menu-sub menu-sub-dropdown w-175px py-4">
                                                                        {/* <!--begin::Menu item-->*/}
                                                                        <div className="menu-item px-3">
                                                                            <a href="#nada" className="menu-link px-3">Admin Group</a>
                                                                        </div>
                                                                        {/* <!--end::Menu item-->*/}
                                                                        {/* <!--begin::Menu item-->*/}
                                                                        <div className="menu-item px-3">
                                                                            <a href="#nada" className="menu-link px-3">Staff Group</a>
                                                                        </div>
                                                                        {/* <!--end::Menu item-->*/}
                                                                        {/* <!--begin::Menu item-->*/}
                                                                        <div className="menu-item px-3">
                                                                            <a href="#nada" className="menu-link px-3">Member Group</a>
                                                                        </div>
                                                                        {/* <!--end::Menu item-->*/}
                                                                    </div>
                                                                    {/* <!--end::Menu sub-->*/}
                                                                ...
                                                                {/* <!--begin::Menu item-->*/}
                                                                <div className="menu-item px-3">
                                                                    <a href="#nada" className="menu-link px-3">New Contact</a>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                                {/* <!--begin::Menu separator-->*/}
                                                                ...
                                                                <div className="menu-item px-3">
                                                                    <div className="menu-content px-3 py-3">
                                                                        <a className="btn btn-primary btn-sm px-4" href="#nada">Generate Reports</a>
                                                                    </div>
                                                                </div>
                                                                {/* <!--end::Menu item-->*/}
                                                            </div>
                                                    ...
                                                    <div className="card-body pt-2">
                                                        ...
                                                        <div className="d-flex align-items-center mb-7">
                                                            ...
                                                            {/* <!--begin::Text-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Emma Smith</a>
                                                        ...
                                                        <div className="d-flex align-items-center mb-7">
                                                            ...
                                                            {/* <!--begin::Text-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Sean Bean</a>
                                                        ...
                                                        <div className="d-flex align-items-center mb-7">
                                                            ...
                                                            {/* <!--begin::Text-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Brian Cox</a>
                                                                <span className="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>
                                                            </div>
                                                            {/* <!--end::Text-->*/}
                                                        </div>
                                                        ...
                                                        <div className="d-flex align-items-center mb-7">
                                                            ...
                                                            {/* <!--begin::Text-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Francis Mitcham</a>
                                                                <span className="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>
                                                            </div>
                                                            {/* <!--end::Text-->*/}
                                                        </div>
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            {/* <!--begin::Text-->*/}
                                                            <div className="flex-grow-1">
                                                                <a href="#nada" className="text-dark fw-bolder text-hover-primary fs-6">Dan Wilson</a>
                                                                <span className="text-muted d-block fw-bold">PHP, SQLite, Artisan CLI</span>
                                                            </div>
                                                            {/* <!--end::Text-->*/}
                                                        </div>
                                                    ...
                                                    <div className="card-body pt-0">
                                                        ...
                                                        <div className="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                                            ...
                                                            <div className="flex-grow-1 me-2">
                                                                <a href="#nada" className="fw-bolder text-gray-800 text-hover-primary fs-6">Group lunch celebration</a>
                                                                <span className="text-muted fw-bold d-block">Due in 2 Days</span>
                                                            </div>
                                                            {/* <!--end::Title-->*/}
                                                            {/* <!--begin::Lable-->*/}
                                                        ...
                                                        <div className="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                                                            ...
                                                            {/* <!--begin::Title-->*/}
                                                            <div className="flex-grow-1 me-2">
                                                                <a href="#nada" className="fw-bolder text-gray-800 text-hover-primary fs-6">Navigation optimization</a>
                                                                <span className="text-muted fw-bold d-block">Due in 2 Days</span>
                                                            </div>
                                                            {/* <!--end::Title-->*/}
                                                            {/* <!--begin::Lable-->*/}
                                                        ...
                                                        <div className="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                                            ...
                                                            {/* <!--begin::Title-->*/}
                                                            <div className="flex-grow-1 me-2">
                                                                <a href="#nada" className="fw-bolder text-gray-800 text-hover-primary fs-6">Rebrand strategy planning</a>
                                                                <span className="text-muted fw-bold d-block">Due in 5 Days</span>
                                                            </div>
                                                            {/* <!--end::Title-->*/}
                                                            {/* <!--begin::Lable-->*/}
                                                        ...
                                                        <div className="d-flex align-items-center bg-light-info rounded p-5">
                                                            ...
                                                            {/* <!--begin::Title-->*/}
                                                            <div className="flex-grow-1 me-2">
                                                                <a href="#nada" className="fw-bolder text-gray-800 text-hover-primary fs-6">Product goals strategy</a>
                                                    ...
                                                    <div className="card-body pt-5">
                                                        ...
                                                        <div className="d-flex align-items-sm-center mb-7">
                                                            ...
                                                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                                                <div className="flex-grow-1 me-2">
                                                                    <a href="#nada" className="text-gray-800 text-hover-primary fs-6 fw-bolder">Top Authors</a>
                                                        ...
                                                        <div className="d-flex align-items-sm-center mb-7">
                                                            ...
                                                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                                                <div className="flex-grow-1 me-2">
                                                                    <a href="#nada" className="text-gray-800 text-hover-primary fs-6 fw-bolder">Popular Authors</a>
                                                        ...
                                                        <div className="d-flex align-items-sm-center mb-7">
                                                            ...
                                                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                                                <div className="flex-grow-1 me-2">
                                                                    <a href="#nada" className="text-gray-800 text-hover-primary fs-6 fw-bolder">New Users</a>
                                                        ...
                                                        <div className="d-flex align-items-sm-center mb-7">
                                                            ...
                                                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                                                <div className="flex-grow-1 me-2">
                                                                    <a href="#nada" className="text-gray-800 text-hover-primary fs-6 fw-bolder">Active Customers</a>
                                                                    <span className="text-muted fw-bold d-block fs-7">Mark, Rowling, Esther</span>
                                                                </div>
                                                        ...
                                                        <div className="d-flex align-items-sm-center mb-7">
                                                            ...
                                                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                                                <div className="flex-grow-1 me-2">
                                                                    <a href="#nada" className="text-gray-800 text-hover-primary fs-6 fw-bolder">Bestseller Theme</a>
                                            ...
                                            <div className="col-xxl-4">
                                                ...
                                                <div className="card card-xxl-stretch mb-xl-8">
                                                    ...
                                                    <div className="card-body d-flex flex-column">
                                                        {/* <!--begin::Chart-->*/}
                                                        <div className="mixed-widget-5-chart card-rounded-top height-150" data-kt-chart-color="success"></div>
                                                        {/* <!--end::Chart-->*/}
                                                        {/* <!--begin::Items-->*/}
                                                        <div className="mt-5">
                                                            {/* <!--begin::Item-->*/}
                                                            <div className="d-flex flex-stack mb-5">
                                                                ...
                                                                <div className="d-flex align-items-center me-2">
                                                                    ...
                                                                    {/* <!--begin::Title-->*/}
                                                                    <div>
                                                                        <a href="#nada" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Top Authors</a>
                                                            ...
                                                            <div className="d-flex flex-stack mb-5">
                                                                ...
                                                                <div className="d-flex align-items-center me-2">
                                                                    ...
                                                                    {/* <!--begin::Title-->*/}
                                                                    <div>
                                                                        <a href="#nada" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Top Sales</a>
                                                            ...
                                                            <div className="d-flex flex-stack">
                                                                ...
                                                                <div className="d-flex align-items-center me-2">
                                                                    ...
                                                                    {/* <!--begin::Title-->*/}
                                                                    <div className="py-1">
                                                                        <a href="#nada" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Top Engagement</a>
                                                                    ...
                                                                    <table className="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">Brad Simmons</a>
                                                                                ...
                                                                                <td className="text-end">
                                                                                    <a href="#nada" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">Popular Authors</a>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">New Users</a>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">Active Customers</a>
                                                                                    <span className="text-muted fw-bold d-block">Movie Creator</span>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a href="#nada" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">Bestseller Theme</a>
                                        ...
                                        <div className="timeline-content mb-10 mt-n1">
                                            ...
                                            <div className="overflow-auto pb-5">
                                                ...
                                                <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                                    {/* <!--begin::Title-->*/}
                                                    <a href="#nada" className="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Meeting with customer</a>
                                                    {/* <!--end::Title-->*/}
                                                    {/* <!--begin::Label-->*/}
                                                    ...
                                                    {/* <!--end::Progress-->*/}
                                                    {/* <!--begin::Action-->*/}
                                                    <a href="#nada" className="btn btn-sm btn-light btn-active-light-primary">View</a>
                                                    {/* <!--end::Action-->*/}
                                                </div>
                                                {/* <!--end::Record-->*/}
                                                {/* <!--begin::Record-->*/}
                                                <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                                    {/* <!--begin::Title-->*/}
                                                    <a href="#nada" className="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Project Delivery Preparation</a>
                                                    {/* <!--end::Title-->*/}
                                                    {/* <!--begin::Label-->*/}
                                    ...
                                    <div className="timeline-item">
                                        ...
                                        <div className="timeline-content mb-10 mt-n1">
                                            ...
                                            <div className="mb-5 pe-3">
                                                {/* <!--begin::Title-->*/}
                                                <a href="#nada" className="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">3 New Incoming Project Files:</a>
                                                {/* <!--end::Title-->*/}
                                                {/* <!--begin::Description-->*/}
                                                <div className="d-flex align-items-center mt-1 fs-6">
                                                    {/* <!--begin::Info-->*/}
                                                ...
                                                <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                                    ...
                                                    <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                        ...
                                                        <div className="ms-1 fw-bold">
                                                            {/* <!--begin::Desc-->*/}
                                                            <a href="#nada" className="fs-6 text-hover-primary fw-bolder">Finance KPI App Guidelines</a>
                                                            {/* <!--end::Desc-->*/}
                                                            {/* <!--begin::Number-->*/}
                                                    ...
                                                    <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                        ...
                                                        <div className="ms-1 fw-bold">
                                                            {/* <!--begin::Desc-->*/}
                                                            <a href="#nada" className="fs-6 text-hover-primary fw-bolder">Client UAT Testing Results</a>
                                                            {/* <!--end::Desc-->*/}
                                                            {/* <!--begin::Number-->*/}
                                                    ...
                                                    <div className="d-flex flex-aligns-center">
                                                        ...
                                                        <div className="ms-1 fw-bold">
                                                            {/* <!--begin::Desc-->*/}
                                                            <a href="#nada" className="fs-6 text-hover-primary fw-bolder">Finance Reports</a>
                                                            {/* <!--end::Desc-->*/}
                                                            {/* <!--begin::Number-->*/}
                                        ...
                                        <div className="timeline-content mb-10 mt-n1">
                                            ...
                                            <div className="pe-3 mb-5">
                                                ...
                                                <div className="fs-5 fw-bold mb-2">Task
                                                    <a href="#nada" className="text-primary fw-bolder me-1">#45890</a>merged with
                                                    <a href="#nada" className="text-primary fw-bolder me-1">#45890</a>in “Ads Pro Admin Dashboard project:</div>
                                                {/* <!--end::Title-->*/}
                                                {/* <!--begin::Description-->*/}
                                                <div className="d-flex align-items-center mt-1 fs-6">
                                                    {/* <!--begin::Info-->*/}
                                                ...
                                                <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                                    ...
                                                    <div className="overlay me-10">
                                                        ...
                                                        <div className="overlay-layer bg-dark bg-opacity-10 rounded">
                                                            <a href="#nada" className="btn btn-sm btn-primary btn-shadow">Explore</a>
                                                        </div>
                                                        {/* <!--end::Link-->*/}
                                                    </div>
                                                    {/* <!--end::Item-->*/}
                                        ...
                                        <div className="timeline-content mb-10 mt-n1">
                                            ...
                                            <div className="pe-3 mb-5">
                                                ...
                                                <div className="fs-5 fw-bold mb-2">New case
                                                    <a href="#nada" className="text-primary fw-bolder me-1">#67890</a>is assigned to you in Multi-platform Database Design project</div>
                                                {/* <!--end::Title-->*/}
                                                {/* <!--begin::Description-->*/}
                                                <div className="overflow-auto pb-5">
                                                    {/* <!--begin::Wrapper-->*/}
                                                    <div className="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        {/* <!--end::Info-->*/}
                                                        {/* <!--begin::User-->*/}
                                                        <a href="#nada" className="text-primary fw-bolder me-1">Alice Tan</a>
                                                        {/* <!--end::User-->*/}
                                                    </div>
                                                    {/* <!--end::Wrapper-->*/}
                                                </div>
                                            ...
                                            <div className="overflow-auto pb-5">
                                                ...
                                                <div className="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                                                    ...
                                                    <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                                        ...
                                                        {/* <!--end::Content-->*/}
                                                        {/* <!--begin::Action-->*/}
                                                        <a href="#nada" className="btn btn-primary px-6 align-self-center text-nowrap">Proceed</a>
                                                        {/* <!--end::Action-->*/}
                                                    </div>
                                                    {/* <!--end::Wrapper-->*/}
                                                </div>
                                        ...
                                        <div className="timeline-content mt-n1">
                                            ...
                                            <div className="pe-3 mb-5">
                                                ...
                                                <div className="fs-5 fw-bold mb-2">New order
                                                    <a href="#nada" className="text-primary fw-bolder me-1">#67890</a>is placed for Workshow Planning &amp; Budget Estimation</div>
                                                {/* <!--end::Title-->*/}
                                                {/* <!--begin::Description-->*/}
                                                <div className="d-flex align-items-center mt-1 fs-6">
                                                    {/* <!--begin::Info-->*/}
                                                    ...
                                                    {/* <!--end::Info-->*/}
                                                    {/* <!--begin::User-->*/}
                                                    <a href="#nada" className="text-primary fw-bolder me-1">Jimmy Bold</a>
                                                    {/* <!--end::User-->*/}
                                                </div>
                                                {/* <!--end::Description-->*/}
                                            </div>
                        ...
                        <div className="card-header pe-5" id="kt_drawer_chat_messenger_header">
                            ...
                            <div className="card-title">
                                ...
                                <div className="d-flex justify-content-center flex-column me-3">
                                    <a href="#nada" className="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">Brian Cox</a>
                                    {/* <!--begin::Info-->*/}
                            ...
                            <div className="card-toolbar">
                                ...
                                <div className="me-2">
                                    ...
                                    <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                        ...
                                        {/* <!--begin::Menu item-->*/}
                                        <div className="menu-item px-3">
                                            <a href="#nada" className="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Add Contact</a>
                                        </div>
                                        {/* <!--end::Menu item-->*/}
                                        {/* <!--begin::Menu item-->*/}
                                        <div className="menu-item px-3">
                                            <a href="#nada" className="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Invite Contacts
                                        ...
                                        <div className="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                            ...
                                            <div className="menu-sub menu-sub-dropdown w-175px py-4">
                                                {/* <!--begin::Menu item-->*/}
                                                <div className="menu-item px-3">
                                                    <a href="#nada" className="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Create Group</a>
                                                </div>
                                                {/* <!--end::Menu item-->*/}
                                                {/* <!--begin::Menu item-->*/}
                                                <div className="menu-item px-3">
                                                    <a href="#nada" className="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Invite Members</a>
                                                </div>
                                                {/* <!--end::Menu item-->*/}
                                                {/* <!--begin::Menu item-->*/}
                                                <div className="menu-item px-3">
                                                    <a href="#nada" className="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Settings</a>
                                                </div>
                                                {/* <!--end::Menu item-->*/}
                                            </div>
                                            {/* <!--end::Menu sub-->*/}
                                ...
                                <div className="d-flex justify-content-start mb-10">
                                    ...
                                    <div className="d-flex flex-column align-items-start">
                                        ...
                                        <div className="d-flex align-items-center mb-2">
                                            ...
                                            {/* <!--begin::Details-->*/}
                                            <div className="ms-3">
                                                <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary me-1">Brian Cox</a>
                                    ...
                                    <div className="d-flex flex-column align-items-end">
                                        ...
                                        <div className="d-flex align-items-center mb-2">
                                            ...
                                            <div className="me-3">
                                                ...
                                                <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary ms-1">You</a>
                                            </div>
                                            {/* <!--end::Details-->*/}
                                            {/* <!--begin::Avatar-->*/}
                                            <div className="symbol symbol-35px symbol-circle">
                                ...
                                <div className="mb-0">
                                    ...
                                    <div className="mb-7">
                                        <div className="d-flex flex-stack">
                                            ...
                                            <a href="https://themeforest.net/licenses/standard" className="fw-bold" target="_blank" rel="noreferrer">License FAQs</a>
                                        </div>
                                    </div>
                                    {/* <!--end::Header-->*/}
                                    {/* <!--begin::License-->*/}
                                        ...
                                        <div className="d-flex flex-stack">
                                            <div className="d-flex flex-column">
                                                <div className="d-flex align-items-center mb-1">
                                                    ...
                                                    <i className="text-gray-400 fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="popover" data-bs-custom-class="popover-dark" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Use, by you or one client in a single end product which end users are not charged for."></i>
                                                </div>
                                        ...
                                        <div className="d-flex flex-stack">
                                            <div className="d-flex flex-column">
                                                <div className="d-flex align-items-center mb-1">
                                                    ...
                                                    <i className="text-gray-400 fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="popover" data-bs-custom-class="popover-dark" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Use, by you or one client, in a single end product which end users can be charged for."></i>
                                                </div>
                                    ...
                                    <div className="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
                                        <div className="d-flex flex-stack">
                                            ...
                                            <div className="text-nowrap">
                                                <a href="https://keenthemes.com/contact/" className="btn btn-sm btn-success" target="_blank" rel="noreferrer">Contact Us</a>
                                            </div>
                                        </div>
                                    </div>
                                    {/* <!--end::License-->*/}
                                    ...
                                    <div className="mb-0">
                                        ...
                                        <div className="row g-5">
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                    <div className="overlay-wrapper">
                                                        <img src="assets/media/demos/demo11.png" alt="demo" className="w-100 opacity-25" />
                                                    </div>
                                                    <div className="overlay-layer bg-dark bg-opacity-10">
                                                        <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                                    </div>
                            ...
                            <div className="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                                ...
                                <div className="text-center mb-13">
                                    ...
                                    <div className="text-muted fw-bold fs-5">If you need more info, please check out
                                        <a href="#nada" className="link-primary fw-bolder">FAQ Page</a>.</div>
                                    {/* <!--end::Description-->*/}
                                </div>
                                {/* <!--end::Heading-->*/}
                                    ...
                                    <div className="mh-300px scroll-y me-n7 pe-7">
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Emma Smith</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Melody Macy</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Max Smith</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Sean Bean</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Brian Cox</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Mikaela Collins</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Francis Mitcham</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Olivia Wild</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Neil Owen</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Dan Wilson</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Emma Bold</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Ana Crown</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Robert Doe</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">John Miller</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Lucy Kunic</a>
                                        ...
                                        <div className="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                {/* <!--begin::Details-->*/}
                                                <div className="ms-5">
                                                    <a href="#nada" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Ethan Wilder</a>
                                                ...
                                                <div className="w-100">
                                                    ...
                                                    <div className="fv-row">
                                                        ...
                                                        <label className="d-flex flex-stack cursor-pointer mb-5">
                                                            ...
                                                            {/* <!--begin:Input-->*/}
                                                            <span className="form-check form-check-custom form-check-solid">
                                                                <input className="form-check-input" type="radio" defaultChecked name="framework" defaultValue="1" />
                                                            </span>
                                                            {/* <!--end:Input-->*/}
                                                        </label>
                                                        {/* <!--end::Option-->*/}
                                                ...
                                                <div className="w-100">
                                                    ...
                                                    <div className="fv-row">
                                                        ...
                                                        <label className="d-flex flex-stack cursor-pointer mb-5">
                                                            ...
                                                            {/* <!--begin::Input-->*/}
                                                            <span className="form-check form-check-custom form-check-solid">
                                                                <input className="form-check-input" type="radio" name="dbengine" defaultChecked defaultValue="1" />
                                                            </span>
                                                            {/* <!--end::Input-->*/}
                                                        </label>
                                                        {/* <!--end::Option-->*/}
                            ...
                            <div className="modal-body pt-0 pb-15 px-5 px-xl-20">
                                ...
                                <div className="mb-13 text-center">
                                    ...
                                    <div className="text-muted fw-bold fs-5">If you need more info, please check
                                        <a href="#nada" className="link-primary fw-bolder">Pricing Guidelines</a>.</div>
                                </div>
                                {/* <!--end::Heading-->*/}
                                {/* <!--begin::Plans-->*/}
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
                                        <a href="#nada" className="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3 me-2 active" data-kt-plan="month">Monthly</a>
                                        <a href="#nada" className="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3" data-kt-plan="annual">Annual</a>
                                    </div>
                                    {/* <!--end::Nav group-->*/}
                                    {/* <!--begin::Row-->*/}
                                        ...
                                        <div className="col-lg-6 mb-10 mb-lg-0">
                                            ...
                                            <div className="nav flex-column">
                                                ...
                                                <div className="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
                                                    ...
                                                    <div className="d-flex align-items-center me-2">
                                                        ...
                                                        <div className="form-check form-check-custom form-check-solid form-check-success me-6">
                                                            <input className="form-check-input" type="radio" name="plan" defaultChecked defaultValue="startup" />
                                                        </div>
                                                        {/* <!--end::Radio-->*/}
                                                        {/* <!--begin::Info-->*/}
                                                        <div className="flex-grow-1">
                                                ...
                                                <div className="nav-link btn btn-outline btn-outline-dashed btn-color-dark d-flex flex-stack text-start p-6">
                                                    ...
                                                    {/* <!--begin::Price-->*/}
                                                    <div className="ms-5">
                                                        <a href="#nada" className="btn btn-sm btn-primary">Contact Us</a>
                                                    </div>
                                                    {/* <!--end::Price-->*/}
                                                </div>
                                                {/* <!--end::Tab link-->*/}
...
export default Dashboard_Modelo;
